...
_G.packer_plugins = {
  ...
  ["verilog_systemverilog.vim"] = {
    loaded = true,
    path = "/home/flyinglobster/.local/share/nvim/site/pack/packer/start/verilog_systemverilog.vim",
